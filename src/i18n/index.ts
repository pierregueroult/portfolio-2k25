...
export const texts: Texts = {
  en: {
    ...
    // --- contact form
    "components.contact.name": "Name",
    "components.contact.email": "Email",
    "components.contact.message": "Write down your message here...",
    "components.contact.send": "Send",
    "components.contact.consent": "By submitting this form, you agree to be contacted by email. See the ",
    "components.contact.privacy": "privacy policy",
    "components.contact.consent2": "for more information.",
    // pages
    // --- blog
    ...
    "pages.socials.contact.title": "Send me a message",
    "pages.socials.contact.description": "Have a question, a project, or just want to chat, feel free to reach out!",
    // --- projects
  ...
  fr: {
    ...
    "components.items.about": "à propos de",
    ...
    // --- contact form
    "components.contact.name": "Nom",
    "components.contact.email": "Email",
    "components.contact.message": "Écrivez votre message ici...",
    "components.contact.send": "Envoyer",
    "components.contact.consent": "En soumettant ce formulaire, vous acceptez d'être contacté par email. Voir la ",
    "components.contact.privacy": "politique de confidentialité",
    "components.contact.consent2": "pour plus d'informations.",
    // pages
    // --- blog
    "pages.blog.meta.title": "Blog",
    "pages.blog.meta.description":
    ...
    "pages.socials.contact.title": "M'envoyer un message",
    "pages.socials.contact.description":
      "Vous avez une question, un projet ou juste envie de discuter, n'hésitez pas à me contacter !",
    // --- projects
  ...
  ar: {
    ...
    // --- contact form
    "components.contact.name": "الاسم",
    "components.contact.email": "البريد الإلكتروني",
    "components.contact.message": "اكتب رسالتك هنا",
    "components.contact.send": "إرسال",
    "components.contact.consent": "بإرسال هذا النموذج، أنت توافق على الاتصال بك عبر البريد الإلكتروني. انظر إلى ",
    "components.contact.privacy": "سياسة الخصوصية",
    "components.contact.consent2": "لمزيد من المعلومات.",
    // pages
    // --- blog
    ...
    "pages.socials.contact.title": "أرسل لي رسالة",
    "pages.socials.contact.description": "هل لديك سؤال أو مشروع أو ترغب فقط في الدردشة، لا تتردد في التواصل!",
    // --- projects
